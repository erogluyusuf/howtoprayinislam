...
export default function AsrGuide() {
  ...
  const [activePart, setActivePart] = useState<PartType>("sunnah");
  ...
  const menuItems: { part: PartType; rakat: RakatType; label: string }[] = [
    ...
    { part: "sunnah", rakat: 3, label: `${t("sunnah")} • 3. ${t("rakat")}` },
    { part: "sunnah", rakat: 4, label: `${t("sunnah")} • 4. ${t("rakat")}` },
  ...
  return (
    <div dir={lang === "ar" ? "rtl" : "ltr"} className="w-full">
      <BasePrayerGuide
        title={t("asr_title")}
        subtitle={t("asr_subtitle")}
        description={t("asr_description")}
      >
        <VerseHadithBlock />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activePart === "sunnah" && activeRakat === 1 && (
                <>
                  <Step num={1} title={t("asr_s_r1_s1_title")} desc={t("asr_s_r1_s1_desc")} image="/iftitahtekbiri.png" image2="/iftitahtekbiri-W.png" />
                  <Step num={2} title={t("asr_qiyam_title")} desc={t("asr_s_r1_s2_desc")} isRed image="/Kıyam.png" image2="/Kıyam-W.png" />
                  <Step num={3} title={t("asr_ruku_title")} desc={t("asr_ruku_desc")} image="/Rükû.png" image2="/Rükû-W.png" />
                  <Step num={4} title={t("asr_kavme_title")} desc={t("asr_kavme_desc")} isRed image="/Kavme.png" image2="/Kavme-W.png" />
                  <Step num={5} title={t("asr_secde_title")} desc={t("asr_secde_desc")} image="/Secde.png" image2="/Secde-W.png" />
                </>
              )}
              {activePart === "sunnah" && activeRakat === 2 && (
                <>
                  <Step num={1} title={t("asr_qiyam_title")} desc={t("asr_r2_s1_desc")} isRed image="/Kıyam.png" image2="/Kıyam-W.png" />
                  <Step num={2} title={t("asr_ruku_title")} desc={t("asr_ruku_desc")} image="/Rükû.png" image2="/Rükû-W.png" />
                  <Step num={3} title={t("asr_secde_title")} desc={t("asr_secde_desc")} image="/Secde.png" image2="/Secde-W.png" />
                  <Step num={4} title={t("asr_ilk_oturus_title")} desc={t("asr_s_r2_oturus_desc")} isRed image="/Celse.png" image2="/Celse-W.png" />
                </>
              )}
              {activePart === "sunnah" && activeRakat === 3 && (
                <>
                  <Step num={1} title={t("asr_qiyam_title")} desc={t("asr_s_r3_s1_desc")} isRed image="/Kıyam.png" image2="/Kıyam-W.png" />
                  <Step num={2} title={t("asr_ruku_title")} desc={t("asr_ruku_desc")} image="/Rükû.png" image2="/Rükû-W.png" />
                  <Step num={3} title={t("asr_secde_title")} desc={t("asr_secde_desc")} image="/Secde.png" image2="/Secde-W.png" />
                </>
              )}
              {activePart === "sunnah" && activeRakat === 4 && (
                <>
                  <Step num={1} title={t("asr_qiyam_title")} desc={t("asr_r4_s1_desc")} isRed image="/Kıyam.png" image2="/Kıyam-W.png" />
                  <Step num={2} title={t("asr_ruku_title")} desc={t("asr_ruku_desc")} image="/Rükû.png" image2="/Rükû-W.png" />
                  <Step num={3} title={t("asr_secde_title")} desc={t("asr_secde_desc")} image="/Secde.png" image2="/Secde-W.png" />
                  {/* SAĞ-SOL SELAM GÖRSELLERİ BURAYA EKLENDİ */}
                  <Step num={4} title={t("asr_son_oturus_title")} desc={t("asr_son_oturus_desc")} isRed image="/Celse.png" image2="/Celse-W.png" image3="/Selam-right.png" image4="/Selam-left.png" image5="/Selam-right-W.png" image6="/Selam-left-W.png" />
                </>
              )}
              ...
              {activePart === "fard" && activeRakat === 1 && (
                <>
                  <Step num={1} title={t("asr_f_r1_s1_title")} desc={t("asr_f_r1_s1_desc")} image="/iftitahtekbiri.png" image2="/iftitahtekbiri-W.png" />
                  <Step num={2} title={t("asr_qiyam_title")} desc={t("asr_s_r1_s2_desc")} isRed image="/Kıyam.png" image2="/Kıyam-W.png" />
                  <Step num={3} title={t("asr_ruku_title")} desc={t("asr_ruku_desc")} image="/Rükû.png" image2="/Rükû-W.png" />
                  <Step num={4} title={t("asr_kavme_title")} desc={t("asr_kavme_desc")} isRed image="/Kavme.png" image2="/Kavme-W.png" />
                  <Step num={5} title={t("asr_secde_title")} desc={t("asr_secde_desc")} image="/Secde.png" image2="/Secde-W.png" />
              ...
              {activePart === "fard" && activeRakat === 2 && (
                <>
                  ...
                  <Step num={2} title={t("asr_ruku_title")} desc={t("asr_ruku_desc")} image="/Rükû.png" image2="/Rükû-W.png" />
                  <Step num={3} title={t("asr_secde_title")} desc={t("asr_secde_desc")} image="/Secde.png" image2="/Secde-W.png" />
                  <Step num={4} title={t("asr_ilk_oturus_title")} desc={t("asr_f_r2_oturus_desc")} isRed image="/Celse.png" image2="/Celse-W.png" />
                </>
              )}
              {activePart === "fard" && activeRakat === 3 && (
                <>
                  <Step num={1} title={t("asr_qiyam_title")} desc={t("asr_f_r3_s1_desc")} isRed image="/Kıyam.png" image2="/Kıyam-W.png" />
                  <Step num={2} title={t("asr_ruku_title")} desc={t("asr_ruku_desc")} image="/Rükû.png" image2="/Rükû-W.png" />
                  <Step num={3} title={t("asr_secde_title")} desc={t("asr_secde_desc")} image="/Secde.png" image2="/Secde-W.png" />
                </>
              )}
              {activePart === "fard" && activeRakat === 4 && (
                <>
                  <Step num={1} title={t("asr_qiyam_title")} desc={t("asr_f_r4_s1_desc")} isRed image="/Kıyam.png" image2="/Kıyam-W.png" />
                  <Step num={2} title={t("asr_ruku_title")} desc={t("asr_ruku_desc")} image="/Rükû.png" image2="/Rükû-W.png" />
                  <Step num={3} title={t("asr_secde_title")} desc={t("asr_secde_desc")} image="/Secde.png" image2="/Secde-W.png" />
                  {/* SAĞ-SOL SELAM GÖRSELLERİ BURAYA EKLENDİ */}
                  <Step num={4} title={t("asr_son_oturus_title")} desc={t("asr_son_oturus_desc")} isRed image="/Celse.png" image2="/Celse-W.png" image3="/Selam-right.png" image4="/Selam-left.png" image5="/Selam-right-W.png" image6="/Selam-left-W.png" />
